...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define FULL_CYCLE_COUNTS 4096  // Example encoder counts for a full cycle (depends on your encoder resolution)
#define QUARTER_CYCLE_COUNTS (FULL_CYCLE_COUNTS / 4)
#define HALF_CYCLE_COUNTS (FULL_CYCLE_COUNTS / 2)
